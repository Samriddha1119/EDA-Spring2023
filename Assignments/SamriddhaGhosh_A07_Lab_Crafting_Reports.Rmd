...
Objectives . . . . . . . . . . . . . . . . . . . . . . . . . .1
Directions . . . . . . . . . . . . . . . . . . . . . . . . . .1
Task 1 - Basic Markdown . . . . . . . . . . . . . . . . . . . 1
Task 2 - Import packages and data, suppressing messages . . . 2
Task 3: Creating tables . . . . . . . . . . . . . . . . . . . 2
Task 3: Plots . . . . . . . . . . . . . . . . . . . . . . . . 4
Task 4: Knit and submit. . . . . . . . . . . . . . . . . . . .5
...
kable(summary_Ozone, caption = "Mean Ozone", col.names = c("County", "µg/m3"))
kable(summary_PM25, caption="Mean Particulates (2.5mm)",col.names = c("County", "µg/m3"))
...
epa_data %>%
  ...
  ggplot(mapping=aes(x=month(Month, label=TRUE), 
           ...
           geom_boxplot()+
           theme_bw()+
           labs(x="Month",y="Concentration of Ozone in µg/m3")
```
...
epa_data %>%
  ...
  ggplot(mapping=aes(x=month(Month, label=TRUE), 
           ...
           geom_boxplot()+
           theme_bw()+
           labs(x="Month",y="Concentration of Particulates of 2.5mm in µg/m3")
```
...
### Git Repository
https://github.com/Samriddha1119/EDA-Spring2023.git
